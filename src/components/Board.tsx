...
// const BoardDiv = styled.div<IBoardDivProps & IisVisible>` <- 이걸 몰라서 props 인터페이스를 Iprops로 통합해서 인터페이스 줬는데 이상한 에러 막 터졌음
//   display: flex;
//   flex-wrap: wrap;
//   border-radius: 0.5rem;
//   width: ${(props) => props.boardSize * 6.25}rem;
...
// const BoardDiv = styled.div<Iprops>`
//   display: flex;
//   flex-wrap: wrap;
//   border-radius: 0.5rem;
//   width: ${(props) => props.boardSize * 6.25}rem;
...
// const VisibleButton = styled.button<Iprops>`
//   color: ${(props) => (props.isVisible ? "white" : "red")};
// `;
